...
def model_create_1DCNN(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(256, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
    model.add(Dropout(0.5))  # 0.8 - lead to lower accuracy, less spread
    # model.add(MaxPooling1D(pool_size=(8)))
    model.add(Conv1D(128, 5, padding='same'))
    model.add(Activation('relu'))
    model.add(Dropout(0.5))  # 0.2 - lead to lower accuracy, less spread
    model.add(Flatten())
...
# Create a CNN model using the specified structure
def model_create_1DCNN1(inputShape, outputShape):
    model = Sequential()
...
# Create a CNN model using the specified structure
def model_create_1DCNN2(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(256, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
...
# Create a CNN model using the specified structure
def model_create_1DCNN3(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(256, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
...
# Create a CNN model using the specified structure
def model_create_1DCNN4(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(512, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
...
# Create a CNN model using the specified structure
def model_create_1DCNN5(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(512, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
...
# Create a CNN model using the specified structure
def model_create_1DCNN6(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(256, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
    model.add(Dropout(0.1))  # 0.8 - lead to lower accuracy, less spread
    # model.add(MaxPooling1D(pool_size=(8)))
    model.add(Conv1D(128, 5, padding='same'))
    model.add(Activation('relu'))
    model.add(Dropout(0.1))  # 0.2 - lead to lower accuracy, less spread
    model.add(Conv1D(64, 5, padding='same'))
    model.add(Activation('relu'))
...
# Create a CNN model using the specified structure
def model_create_1DCNN7(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(512, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
...
def model_create_1DCNN8(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(512, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
...
# Create a CNN model using the specified structure
# 내가 새롭게 시도해본것
def model_create_1DCNN9(inputShape, outputShape):
    model = Sequential()
    model.add(Conv1D(256, 5, padding='same',
                     input_shape=inputShape))
    model.add(Activation('relu'))
    model.add(Dropout(0.4))  # 0.8 - lead to lower accuracy, less spread
    model.add(AveragePooling1D(pol_size=2))   #Average pooling layer 추가
    
    # model.add(MaxPooling1D(pool_size=(8)))
    model.add(Conv1D(128, 5, padding='same'))
    model.add(Activation('relu'))
    model.add(Dropout(0.4))  # 0.2 - lead to lower accuracy, less spread
    model.add(AveragePooling1D(pol_size=2))
...
def run_model_audio(featureDF, fullDF, labelKey, kfoldSplits, origin, batchSize, epochLimit):
    ...
    for trainIndex, testIndex, in kf.split(featureDF):
        ...
        AP_Model = model_create_1DCNN6(inShape, yTrain.shape[1])
